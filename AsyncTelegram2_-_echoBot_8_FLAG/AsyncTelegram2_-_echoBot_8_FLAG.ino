...
//int64_t userid =-4218515670 ; //id grup dun=-4175257531
...
byte MK32_F=0;
String message ;
int64_t userid =-4218515670 ; //id grup dun=-4128298459         
...
void loop()
{
  ...
  if (myBot.getNewMessage(msg)) {
    ...
    LOAD();
    String reply;
    //Jika ingin di perbanyak, copy dengan template -> NM_MKx +MK1x_F -> x=nomer kontak
    reply=NM_MK1 + MK1_F + NM_MK2 +MK2_F+ NM_MK3 +MK3_F + NM_MK4 +MK4_F + NM_MK5 +MK5_F + NM_MK6 +MK6_F +
     NM_MK7 +MK7_F + NM_MK8 +MK8_F + NM_MK9 + MK9_F + NM_MK10 +MK10_F +NM_MK11 +MK11_F;
...
//      String reply;
//      reply = (String)"Welcome " + msg.sender.username + (String)" ,please type command below.\n Command: TEST, STATUS.";
