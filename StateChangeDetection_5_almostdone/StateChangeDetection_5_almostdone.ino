...
const int buttonPin_1 = 32;  // the pin that the pushbutton is attached to
const int buttonPin_2 = 33;  // the pin that the pushbutton is attached to
const int buttonPin_3 = 34;  // the pin that the pushbutton is attached to
const int buttonPin_4 = 35;  // the pin that the pushbutton is attached to
const int buttonPin_5 = 36;  // the pin that the pushbutton is attached to
const int buttonPin_6 = 37;  // the pin that the pushbutton is attached to
const int buttonPin_7 = 38;  // the pin that the pushbutton is attached to
const int buttonPin_8 = 39;  // the pin that the pushbutton is attached to
const int buttonPin_9 = 40;  // the pin that the pushbutton is attached to
const int buttonPin_10 = 41;  // the pin that the pushbutton is attached to
const int buttonPin_11 = 42;  // the pin that the pushbutton is attached to
const int buttonPin_12 = 43;  // the pin that the pushbutton is attached to
const int buttonPin_13 = 44;  // the pin that the pushbutton is attached to
const int buttonPin_14 = 45;  // the pin that the pushbutton is attached to
const int buttonPin_15 = 46;  // the pin that the pushbutton is attached to
const int buttonPin_16 = 47;  // the pin that the pushbutton is attached to
const int buttonPin_17 = 16;  // the pin that the pushbutton is attached to
const int buttonPin_18 = 17;  // the pin that the pushbutton is attached to
const int buttonPin_19 = 18;  // the pin that the pushbutton is attached to
const int buttonPin_20 = 19;  // the pin that the pushbutton is attached to
const int buttonPin_21 = 20;  // the pin that the pushbutton is attached to
const int buttonPin_22 = 21;  // the pin that the pushbutton is attached to
const int buttonPin_23 = 22;  // the pin that the pushbutton is attached to
const int buttonPin_24 = 23;  // the pin that the pushbutton is attached to
const int buttonPin_25 = 24;  // the pin that the pushbutton is attached to
const int buttonPin_26 = 25;  // the pin that the pushbutton is attached to
const int buttonPin_27 = 26;  // the pin that the pushbutton is attached to
const int buttonPin_28 = 27;  // the pin that the pushbutton is attached to
const int buttonPin_29 = 28;  // the pin that the pushbutton is attached to
const int buttonPin_30 = 29;  // the pin that the pushbutton is attached to
const int buttonPin_31 = 30;  // the pin that the pushbutton is attached to
const int buttonPin_32 = 31;  // the pin that the pushbutton is attached to
...
void setup() {
  ...
  pinMode(buttonPin_13, INPUT_PULLUP);
  pinMode(buttonPin_14, INPUT_PULLUP);
  pinMode(buttonPin_15, INPUT_PULLUP);
  pinMode(buttonPin_16, INPUT_PULLUP);
  pinMode(buttonPin_17, INPUT_PULLUP);
  pinMode(buttonPin_18, INPUT_PULLUP);
  pinMode(buttonPin_19, INPUT_PULLUP);
  pinMode(buttonPin_20, INPUT_PULLUP);

  pinMode(buttonPin_21, INPUT_PULLUP);
  pinMode(buttonPin_22, INPUT_PULLUP);
  pinMode(buttonPin_23, INPUT_PULLUP);
  pinMode(buttonPin_24, INPUT_PULLUP);
  pinMode(buttonPin_25, INPUT_PULLUP);
  pinMode(buttonPin_26, INPUT_PULLUP);
  pinMode(buttonPin_27, INPUT_PULLUP);
  pinMode(buttonPin_28, INPUT_PULLUP);
  pinMode(buttonPin_29, INPUT_PULLUP);
  pinMode(buttonPin_30, INPUT_PULLUP);
...
void STATUS(){
   // read the pushbutton input pin:
 if(MK1==closed){
   Serial.println("MK_1 STATUS Closed");
    Serial3.print("1OC");
    Serial3.print("#");
    delay(200);
 }
 else if(MK1==opened){
    Serial.println("MK_1 STATUS Opened");
    Serial3.print("1OO");
    Serial3.print("#");
    delay(200);
 }
 ...
 if(MK2==closed){
     Serial.println("MK_2 STATUS closed");
    Serial3.print("1CC");
    Serial3.print("#");
    delay(200);
 }
