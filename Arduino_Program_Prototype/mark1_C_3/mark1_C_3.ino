...
if( digitalRead(pin[1])==LOW && digitalRead(pin[2])==LOW ) { t10.setText("HOME"); }
if( digitalRead(pin[1])==HIGH && digitalRead(pin[2])==LOW ) { t10.setText("KANAN"); }
if( digitalRead(pin[1])==LOW && digitalRead(pin[2])==HIGH ) { t10.setText("KIRI"); }
if( digitalRead(pin[1])==HIGH && digitalRead(pin[2])==HIGH ) { t10.setText("EMERGENCY"); }
