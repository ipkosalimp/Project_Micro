...
void baca_posisi_sensor_slider(){
...
void baca_posisi_sensor_gambar(){
if( digitalRead(pin[3])==LOW && digitalRead(pin[4])==LOW && digitalRead(pin[5])==LOW) {  p0.setPic(17); }  //AWAL  //17 atau 9
...
if( digitalRead(pin[0])==HIGH && digitalRead(pin[1])==LOW && digitalRead(pin[2])==HIGH ) { t1.setText("STOP"); t1b.setText("STOP"); t10.setText("PAUSE"); }
if( digitalRead(pin[0])==LOW && digitalRead(pin[1])==HIGH && digitalRead(pin[2])==HIGH ) { t1.setText("RUNNING"); t10.setText("TURUN"); }
if( digitalRead(pin[0])==HIGH && digitalRead(pin[1])==HIGH && digitalRead(pin[2])==HIGH ) { t1.setText("STOP"); t1b.setText("STOP"); t10.setText("-"); }
...
baca_indikator_tombol();

baca_posisi_sensor_slider();
...
while(mulai==1){
baca_posisi_sensor_gambar();
baca_indikator_tombol();
baca_urutan_proses();
//baca status
if( digitalRead(pin[0])==HIGH && digitalRead(pin[1])==LOW && digitalRead(pin[2])==HIGH ) { movepage1=1; mulai=0; }
if( digitalRead(pin[0])==HIGH && digitalRead(pin[1])==HIGH && digitalRead(pin[2])==HIGH ) { movepage1=1; mulai=0; }
