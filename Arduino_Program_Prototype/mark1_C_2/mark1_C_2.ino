...
// BACA POSISI SENSOR
else if( digitalRead(pin[3])==LOW && digitalRead(pin[4])==LOW && digitalRead(pin[5])==LOW) { posisi.setValue(0); }  //AWAL
...
else if( digitalRead(pin[3])==HIGH && digitalRead(pin[4])==HIGH && digitalRead(pin[5])==HIGH) { posisi.setValue(7); }//7
