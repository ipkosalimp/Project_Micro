...
if( digitalRead(pin[3])==LOW && digitalRead(pin[4])==LOW && digitalRead(pin[5])==LOW) {  p0.setPic(16); }  //AWAL
if( digitalRead(pin[3])==HIGH && digitalRead(pin[4])==LOW && digitalRead(pin[5])==LOW) { p0.setPic(9);} //1
if( digitalRead(pin[3])==LOW && digitalRead(pin[4])==HIGH && digitalRead(pin[5])==LOW) { p0.setPic(10);} //2
if( digitalRead(pin[3])==HIGH && digitalRead(pin[4])==HIGH && digitalRead(pin[5])==LOW) { p0.setPic(11);} //3
if( digitalRead(pin[3])==LOW && digitalRead(pin[4])==LOW && digitalRead(pin[5])==HIGH) {  p0.setPic(12);} //4
if( digitalRead(pin[3])==HIGH && digitalRead(pin[4])==LOW && digitalRead(pin[5])==HIGH) { p0.setPic(13);} //5
if( digitalRead(pin[3])==LOW && digitalRead(pin[4])==HIGH && digitalRead(pin[5])==HIGH) { p0.setPic(14);}//6
if( digitalRead(pin[3])==HIGH && digitalRead(pin[4])==HIGH && digitalRead(pin[5])==HIGH) {  p0.setPic(15);}//7
}
