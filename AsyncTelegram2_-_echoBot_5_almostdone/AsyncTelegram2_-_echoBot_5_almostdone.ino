...
/*
   ...
   Core     : esp32 1.0.6 - esp8266 3.0.0
...
2. Install ESP8266 Versi 3.0.0 , file_> preference->copy package
...
//int64_t userid = 7190192639; id bot
//int64_t userid = 5696629558; //id pinidiz
