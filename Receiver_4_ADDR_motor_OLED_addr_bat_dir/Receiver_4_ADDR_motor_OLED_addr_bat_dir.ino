...
//      Serial.println("2");
  ...
  display.print("-BWD-");
      ...
      analogWrite(3, 255); //PWMA  -> motor Kiri
      digitalWrite(5, 0); //LogicA
      digitalWrite(6, 1); //LogicB  -> motor kanan
      analogWrite(9, 255); //PWMB
//      Serial.println("3");
  display.setCursor(25, 16);
  display.print("-LEFT-");
    }
...
void mainscreen(){
  ...
  display.println("Batry:");
  display.setCursor(75, 32);
  display.println(batvalp);
...
void pracon(){
  ...
  display.print("-PRESS Button3");
  display.setCursor(0, 24);
  display.print("To 'see' ADDR");
  display.setCursor(0, 32);
  display.print("-PRESS & HOLD Button3");
  display.setCursor(0, 40);
  display.print("To 'setting' ADDR");
//    display.setCursor(0, 48);
//    display.print("Average bat=");
//    display.setCursor(70, 48);
//    display.print(average);
  display.setCursor(0, 56);
  display.print("Bat Val=");
...
void checkbat() {
  ...
  readings[readIndex]=analogRead(pinbat);
  total=total+readings[readIndex];
...
//  }
  ...
  //849->4.12
 // average=analogRead(pinbat);
  batval=(average*4.2)/905; //865->remot, 
  batvalp=map(average,695,905,0,100);  //awal 797, aktual penuh=910
